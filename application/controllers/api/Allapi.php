...
class Allapi extends REST_Controller {
    ...
    public function getpembelianheader_post(){
        ...
        $omsettotal= $this->Mallapi->getAlldatabeliheadertotal($datafield,$tgl,$datacari);
        if (count($omsetData) == 0) {
            $jadwal["message"] = "Data sub gol tidak ditemukan";
            $jadwal["success"] = 0;
        }else{
    ...
    public function getdatapenjualan_post(){
        $dataqr = $this->post("dataquery");
        $tgl=$this->post("tgl");
        // $bln=$this->post("bulan");
        $omsetData = $this->Mallapi->getAlldatapenjualan($dataqr,$tgl);
        if (count($omsetData) == 0) {
            $jadwal["message"] = "Data sub gol tidak ditemukan";
            $jadwal["success"] = 0;
        }else{
    ...
    public function getpenjualanheader_post(){
        $datafield = $this->post("datafield");
        $tgl=$this->post("tgl");
        $datacari = $this->post("datacari");
        // $bln=$this->post("bulan");
        $omsetData = $this->Mallapi->getAlldatajualheader($datafield,$tgl,$datacari);
        $omsettotal= $this->Mallapi->getAlldatajualheadertotal($datafield,$tgl,$datacari);
        if (count($omsetData) == 0) {
            $jadwal["message"] = "Data sub gol tidak ditemukan";
            $jadwal["success"] = 0;
        }else{
    ...
    public function getpenjualandetail_post(){ 
        $datapo = $this->post("datapo");
        // $bln=$this->post("bulan");
        $omsetData = $this->Mallapi->getAlldatajualdetail($datapo);
        $dataheader=$this->Mallapi->getAlldatajualdetailheader($datapo);
        if (count($omsetData) == 0) {
            $jadwal["message"] = "Data sub gol tidak ditemukan";
            $jadwal["success"] = 0;
        }else{
    ...
    public function getrugilabadetail_post(){ 
        $datapo = $this->post("datapo");
        // $bln=$this->post("bulan");
        $omsetData = $this->Mallapi->getAlldatarugilabadetail($datapo);
        $dataheader=$this->Mallapi->getAlldatarugilabadetailheader($datapo);
        if (count($omsetData) == 0) {
            $jadwal["message"] = "Data sub gol tidak ditemukan";
            $jadwal["success"] = 0;
        }else{
